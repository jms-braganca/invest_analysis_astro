...
(function () {
  ...
  function injectStyle() {
    ...
    var css =
      ...
      '[data-ticker].is-ready{display:block;position:sticky;top:0;z-index:1001}' +
      '[data-ticker].is-ready ~ .private-topbar{top:38px}' +
      '.tk-tape{position:relative;overflow:hidden;height:38px;background:#f5f5f7;border-bottom:.5px solid rgba(0,0,0,.08)}' +
      'body.theme-dark .tk-tape{background:#0b0b0c;border-bottom-color:rgba(255,255,255,.08)}' +
